...
export default function SiteNavbar() {
  ...
  return (
    <nav ref={navbarRef} className="navbar navbar-expand-lg navbar-light sticky-top p-0 site-navbar">
        ...
        <div className={`collapse navbar-collapse${navOpen ? " show" : ""}`} id="navbarCollapse">
          <div className="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <div className="nav-item dropdown">
              ...
              <ul className={`dropdown-menu dropdown-menu-end bg-light shadow-sm border-0${packagesOpen ? " show" : ""}`}>
                <li>
